...
/**
 * Pre-Interview -> Selected Candidates.
 *
 * THE SAME TABLE AS POST-INTERVIEW > CANDIDATE RECORDS, pinned to one pipeline
 * status (hired). Deliberately not a new list component and not a new query:
  ...
  return (
    <div className="min-h-full bg-white">
      ...
      <PageShell width="wide">
        <BasicDetailsScreen candidates={candidates} canDelete={canDelete} lockedStatus="hired" />
      </PageShell>
    </div>
  );
}
