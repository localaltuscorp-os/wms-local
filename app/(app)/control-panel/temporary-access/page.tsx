 ...
 *
 * The CONTROL PANEL module's own gate still applies on top of this: the room is
 * admin-only and matrix-gated (see `canControlPanel` in
 * lib/auth/workspace-access.ts), so in practice a viewer is both. This screen's
 * gate is stated in terms of the hierarchy because that is the rule the brief
 * names, and because it is the rule the grant action re-checks.
 *
