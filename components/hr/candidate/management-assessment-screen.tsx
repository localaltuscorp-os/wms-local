...
> = {
  ...
  free_training: { status: "free_training", letterKey: "free_training", letterLabel: "Free Training", label: "Free Training" },
  assignment_needed: { status: "assignment_needed", letterKey: "assignment_needed", letterLabel: "Assignment Needed", label: "Assignment Needed" },
};
...
export function ManagementAssessmentScreen({
  ...
  async function emailRecruiter() {
    ...
    if (!oc || oc === "shortlisted" || oc === "free_training" || oc === "assignment_needed" || !email) return;
