...
/**
 * Month picker for the finance payroll-impact dashboard — drives the `?y=&m=`
 * query with a labelled month/year pair plus prev/next chevrons in one frosted
 * segmented pill (mirrors the attendance dashboard's selector, but routes to the
...
export function FinanceMonthSelector({
  ...
  function go(y: number, m: number) {
    ...
    router.push(`/attendance/insights/finance?y=${yy}&m=${mm}` as Route);
  }
