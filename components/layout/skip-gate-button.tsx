  ...
  return (
    <div className="fixed bottom-5 right-5 z-[60]">
      <button
        ...
        disabled={pending}
        className="inline-flex items-center gap-1.5 rounded-pill border border-hairline-strong bg-white/90 px-4 py-2.5 text-[13.5px] font-bold text-ink-strong shadow-lg backdrop-blur transition-transform active:scale-[0.98] hover:border-[color:var(--color-altus-red)] disabled:opacity-60"
