-- PART 2 - VERIFY the Om branch migrations. Read-only. Changes nothing.
-- Every row must say PASS, and the HR count at the bottom must be no lower
-- than the one PART 0 showed. No comments below this line, on purpose.
...
from (values
  ...
  ('0232  incentive_eligibility is still the ROHAN shape (the merge decision)', '',
  ...
  ('0234  employee Function points at functions', '',
  ...
  ('HR    active people in HR — must be no lower than the PART 0 number',
