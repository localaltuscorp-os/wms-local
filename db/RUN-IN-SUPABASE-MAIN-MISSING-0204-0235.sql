...
--
--  Built 2026-09-17 by comparing every table and column the code on main
...
--    · Rakesh's incentive eligibility
...
--  eligibility design is reconciled with Rakesh's (both use the same table).
--
...
--
--  HOW TO RUN
--    1. Run db/VERIFY-MAIN-MISSING-0204-0235.sql — note what says NOT YET.
...
-- ────────────────────────────────────────────────────────────────────────────
--  PART 2 — 14 MIGRATIONS, VERBATIM (one guard marked), IN ORDER, ONE TRANSACTION
-- ────────────────────────────────────────────────────────────────────────────
BEGIN;
